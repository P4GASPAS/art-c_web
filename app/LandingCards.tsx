  ...
  return (
    <>
        <div className="text-center px-24 pb-8">
            <h1 className="text-4xl font-semibold my-4">Top products</h1>
            <p className="tracking-wider">Elevate your motorcycle with a performance-driven setup designed for durability, superior braking, enhanced stability, and efficient cooling, ensuring you're ready for any challenge on the road or track.</p>
        </div>
